...
class StocksManager: IStocksManager {
    ...
    func getAllStocksForSearch(completion: @escaping (Result<[Stock], StocksManagerError>) -> Void) -> Void {
    ...
    func getPrices(for ticker: String) {
...
//            }
    ...
    /// Получить лого акции
    func getLogoUrl(for ticker: String, completion: @escaping (Result<String?, StocksManagerError>) -> Void) {
